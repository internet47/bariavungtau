...
for($cnt=0;$cnt<@current_data;$cnt++){
	...
	$current_data_list .= "<td style=\"width: 40px;\"><img src=\"images/button_edit.gif\" width=\"30\" height=\"20\" alt=\"編集\" class=\"button\" onclick=\"location.href='?m=$form{'m'}&a=form&id=$current_data_info[0]'\" /></td>\n";
	$current_data_list .= "<td style=\"width: 40px;\"><img src=\"images/button_delete.gif\" width=\"30\" height=\"20\" alt=\"削除\" class=\"button\" onclick=\"delete_confirm('?m=$form{'m'}&a=delete&id=${current_data_info[0]}','${current_data_info[1]}');\" /></td>\n";
