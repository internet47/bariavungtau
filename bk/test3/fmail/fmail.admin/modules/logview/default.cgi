...
$print_html = <<"EOF";
	...
	<a href="download.cgi?mode=csvdownload&path=${logdata_path}&line=br" class="download br">ダウンロードする（改行あり）</a>
	<a href="download.cgi?mode=csvdownload&path=${logdata_path}" class="download nobr">ダウンロードする（改行なし）</a>
	<p>
