...
for($cnt=0;$cnt<@current_data;$cnt++){
	...
	$users_list .= "<td style=\"width: 40px;\"><img src=\"images/button_delete.gif\" width=\"30\" height=\"20\" alt=\"削除\" class=\"button\" onclick=\"delete_confirm('?m=$form{'m'}&a=delete&id=${current_record[0]}','${current_record[1]}');\" /></td>\n";
	$users_list .= "</tr>\n";
}
$print_html = <<"EOF";
