...
for($cnt=0;$cnt<@registry;$cnt++){
	...
	$registry_list .= "<td style=\"width: 40px;\"><img src=\"images/button_edit.gif\" width=\"30\" height=\"20\" alt=\"編集\" class=\"button\" onclick=\"location.href='?m=$form{'m'}&a=power_form&id=$registry_info[0]&module=$form{'id'}'\" /></td>\n";
	$registry_list .= "</tr>\n";
}
$print_html = <<"EOF";
