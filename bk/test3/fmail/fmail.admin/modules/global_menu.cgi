...
if($current_user{'power'} eq 'limited-client'){
	...
	($gnavi_flag,$gnavi_expires_start,$gnavi_expires_end,$gnavi_limit,$gnavi_serials,$gnavi_thanks_page,$gnavi_sendmail_path,$gnavi_logsave,$gnavi_cart_in_element,$gnavi_cart_logsave,$gnavi_send_mode,$gnavi_attached_mode,$gnavi_display_mode,$gnavi_logdata_path,$gnavi_cart_logdata_path,$gnavi_mailform_sender_address_name,$gnavi_mailform_sender_address,$gnavi_mail_method,$gnavi_thanks_message,$gnavi_title_mailform,$gnavi_title_confirm,$gnavi_title_error,$gnavi_title_thanks,$gnavi_spamcheck,$gnavi_mail_dustclear,$gnavi_mail_dustclear_zero,$gnavi_client_info,$gnavi_site_url,$gnavi_table_style,$gnavi_th_style,$gnavi_td_style,$gnavi_separate_before,$gnavi_separate_after,$gnavi_flag_afiri,$gnavi_afiri_tag,$gnavi_flag_smartphone_tpl,$gnavi_flag_futurephone_tpl,$gnavi_setlang) = split(/\n/,$gnavi_current_data);
