...
if($current_user{'power'} ne 'limited-client'){
	...
	$print_html = <<"	EOF";
		...
		<div class="setting_info">Setting Info List Open >>></div>
...
$return_html
			...
			<dt class="even">商品カート履歴管理・閲覧　Download：</dt>
			<dd class="even"><span class="check">${cart_log_lastupdate}</span></dd>
			
			<dt>商品カート履歴管理・閲覧　初期化：</dt>
			<dd><span class="check">${cart_log_lastdelete}</span></dd>
			
			<dt class="even">郵便番号辞書更新：</dt>
			<dd class="even"><span class="check">${lastupdate}</span></dd>
