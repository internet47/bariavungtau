...
<form method="POST" action="news.html?do=addnew" name="addnew" enctype="multipart/form-data">
...
<form method="POST" action="news.html?do=updatenew" name="updatenew" enctype="multipart/form-data">
	<table width="100%" border="0" id="lefttable">
    <tbody>
    <tr>
    	<td>Title</td>
