...
function list()		
{
		...
		$.ajax({url: "admin/data/news.xml", cache:false}).done(function(data)
		{
				...
				{		
				    ...
				    var elem = ('<dl><dt><img src="admin/image/'+image+'" width="93" height="59" alt="'+title+'" /></dt><dd class="text_t"><a href="detailnew.php?no='+no+'">'+title+'</a><dd class="dateposted">'+dateposted+'</dt><dd class="detail"><a href="detailnew.php?no='+no+'"><img src="images/b_detail_off.jpg" width="113" height="17" alt="詳細情報を見る" class="details" /></a></dd></dl>');
				...
				var p= ('<p class="news_hist"><a href="news.php"><img src="images/b_index01_off.jpg" width="195" height="41" alt="過去の記事をもっと見る" /></a></p>');
			...
			foreach($xml->children() as $Positions)
			{
				foreach($Positions->children() as $Position => $data)
				{
					...
					if ($no_inxml==$top) 
					{
					 ...
					 echo '</dt>';
             echo  '<dd><span class="title_news"><a href="detailnew.php?no='.$id.'">'.$title.'</a></span><br />'.$short.'';
					}
				}
			}//end foreach
			  ?>
