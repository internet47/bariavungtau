...
<title>写真・動画集 ｜バリア・ブンタウ省進出完全ガイド</title>
...
<div id="wrapper">
  ...
  <div id="wrap_content">
    <div id="main" class="cf">
      ...
      <div class="pathway"><a href="./">バリア・ブンタウ省進出完全ガイド</a> &nbsp;&gt;&gt;&nbsp;写真・動画集</div>
      <div id="content">
        <h3><img src="images/h3_gallery01.jpg" width="725" height="49" alt="????" /></h3>
        <div id="example">
          <div class="imageRow">
            <div class="set">
              <?php 
				...
				else
				{
					...
					{
					$str =$str.'
						<div class="single"><a href="admin/uploads/images/'.$value['image'].'" rel="prettyPhoto[gallery]" title="'.$value['title'].'"  des="'.$value['description'].'">
          ...
          <h3><img src="images/h3_gallery02.jpg" width="725" height="49" alt="????" /></h3>
          <div class="imageRow">
            <div class="set">
              <?php 
			  	//include('config.php');
					...
					foreach($datavideo as $val)
					{
						...
						else
						{
							if($val['link']!='' && $val['video']!='')
							{
								...
								$str =$str.'
								<div class="single">
								<a href="'.$val['link'].'" rel="prettyPhoto" title="'.$val['title'].'" des="'.$val['description'].'">
								<img src="images/gallery/thumb-7.jpg" alt="'.$val['title'].'" /><p>'.$val['title'].'</p></a>
								</div>
								';
							}
							else
							{
								...
								else
								{
									...
									$str =$str.'
									<div class="single">
								<a href="'.$val['link'].'" rel="prettyPhoto" title="asdasdasdas" des="'.$val['description'].'">
								<img src="images/gallery/thumb-7.jpg" alt="'.$val['title'].'" /><p>'.$val['title'].'</p></a>
								</div>
										';
								}
