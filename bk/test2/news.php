...
$.ajax({url: "admin/data/news.xml", cache:false}).done(function(data)
		{	
				...
				var page =Math.round(Total/number_topic);
				...
				$('#NoSlide').attr({"data1":"0","data2":"4"}); //khai báo mặc định.
...
function list_page(num1,num2)		
{
		...
		{	 
				$(data).find("New").slice(num1,num2).each(function()//11 tin
				{
				 ...
				 var elem =('<dl><dt><p>'+dateposted+'</p></dt><dd class="text_t"><a href="detailnew.php?no='+no+'"><p class="img_detail"><img src="admin/image/thumb2/'+image+'" width="100" alt=" "/></p>'+title+'</a></dd><dd class="detail"><a href="detailnew-'+no+'.html"><img src="images/b_detail_off.jpg" width="113" height="17" alt="詳細情報を見る" /></a></dd></dl>');
