...
<title>更新情報 ｜バリアブンタウ省進出完全ガイド</title>
...
function list()		
{
		...
		{	 
				$(data).find("New").each(function()
				{
				 ...
				 var elem =('<dl><dt><img src="admin/image/'+image+'" width="93" height="59" alt=" "/></dt><dd class="text_t">'+title+'</dd><dd class="detail"><a href="detailnew.php"><img src="images/b_detail_off.jpg" width="113" height="17" alt="もっと見る" /></a></dd></dl>');
...
<div id="wrapper">
  <div id="header">
    <h1>更新情報 ｜バリアブンタウ省進出完全ガイド</h1>
    <div id="logo">
      <p><img src="images/logo.jpg" width="635" height="106" alt="バリアブンタウ省進出完全ガイド" /></p>
      <ul>
        <li><img src="images/tel.jpg" width="238" height="50" alt="(84)-64-385-0019 毎日:08：00AM～17：00PM" /></li>        <li><a href="fmail/fmail.cgi"><img src="images/b_mail_off.jpg" alt="メールでお問い合わせはこちらから" width="238" height="50" border="0" /></a></li>
</ul>
    </div>
      <div id="globalNav" class="clearfix">
      <ul id="global-navi">
        <li><a href="#"><img src="images/b_navi01_off.jpg" width="144" height="47" alt="トップページ" /></a></li>
        <li><a href="news.php"><img src="images/b_navi02_off.jpg" width="119" height="47" alt="更新情報 " /></a></li>
        <li><img src="images/b_navi03_off.jpg" width="123" height="47" alt="基本情報" />
                <ul>
            <li><a href="infobaria/greeting.html">ご挨拶（委員長）</a></li>
            <li><a href="infobaria/access.html">アクセス（地図、方法）</a></li>
            <li><a href="infobaria/history_baria.html">バリア･ブンタウ省の歴史</a></li>
            <li><a href="infobaria/index.html">地理位置、気候、経済発展情況</a></li>
          </ul>
        </li>
        <li><a href="industry/index.html"><img src="images/b_navi04_off.jpg" width="154" height="47" alt="工業団地情報" /></a></li>
        <li><a href="living_information.php"><img src="images/b_navi05_off.jpg" width="123" height="47" alt="生活情報" /></a></li>
      ...
      <div id="nav">
        <div class="box_snavi_orang">
          ...
          <ul>
            ...
            <li><a href="infobaria/access.html"><img src="images/b_snavi02_off.jpg" width="234" height="55" alt="アクセス（地図、方法）" /></a></li>
            <li><a href="infobaria/history_baria.html"><img src="images/b_snavi03_off.jpg" width="234" height="55" alt="バリア･ブンタウ省の歴史" /></a></li>
            <li><a href="infobaria/index.html"><img src="images/b_snavi04_off.jpg" width="234" height="55" alt="地理位置、気候、経済発展情況" /></a></li>
          </ul>
        </div>
        ...
        <div class="box_snavi_blue">
          ...
          <ul>
            <li><a href="living_information.php"><img src="images/b_snavi08_off.jpg" width="234" height="41" alt="生活情報マップ" /></a></li>
            <li><a href="industry/index.html"><img src="images/b_snavi09_off.jpg" width="234" height="41" alt="工業団地マップ" /></a></li>            <li><a href="gallery.php"><img src="images/b_snavi10_off.jpg" width="234" height="41" alt="写真・動画集" /></a></li>
...
<li><a href="partner.html"><img src="images/b_snavi12_off.jpg" width="234" height="41" alt="パートナーリンク" /></a></li>
        ...
        <p><img src="images/banner_snavi_01.jpg" width="240" height="90" alt=" " /></p>
        <p><img src="images/banner_snavi_01.jpg" width="240" height="90" alt=" " /></p>
        <p><img src="images/banner_snavi_02.jpg" width="240" height="90" alt=" " /></p>
        <!-- / #nav --></div>
      
      <!-- / #main --></div>
  </div>
  <div id="footer">
    <p class="pagetop"><a href="#header"><img src="images/b_page_top.jpg" alt="" /></a></p>
    <div id="footer_link">
      <ul>
        <li class="title_home"><a href="#">TOPページ</a> </li>
        <li><a href="news.php">更新情報</a></li>
        <li><a href="living_information.php">生活情報</a></li>
      ...
      <ul>
        ...
        <li><a href="industry/phumy3_industry.html">フミ III工業団地</a></li>
      ...
      <ul class="last">
        ...
        <li><a href="investment/investor_attraction.html">企業誘致のご案内</a></li>
        <li><a href="investment/policy.html">優遇政策</a></li>        <li><a href="investment/infrastructure.html">バリア・ブンタウ省への企業の進出メリット</a></li>
<li><a href="investment/invesment_process.html">投資プロセス</a></li>
        <li><a href="investment/japanese_list.html">進出日系企業一覧</a></li>
      </ul>
    </div>
    <address id="copyright" class="clearfix">
    Copyright &copy; 株式会社 松和建設 All Rights Reserved.
    </address>
    <!-- / #footer --></div>
