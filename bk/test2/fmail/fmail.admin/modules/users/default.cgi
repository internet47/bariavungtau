...
for($cnt=0;$cnt<@users;$cnt++){
	...
	$users_list .= "<td style=\"width: 40px;\"><img src=\"images/button_edit.gif\" width=\"30\" height=\"20\" alt=\"編集\" class=\"button\" onclick=\"location.href='?m=$form{'m'}&a=form&id=$users_info[0]'\" /></td>\n";
	$users_list .= "<td style=\"width: 40px;\"><img src=\"images/button_delete.gif\" width=\"30\" height=\"20\" alt=\"削除\" class=\"button\" onclick=\"delete_confirm('?m=$form{'m'}&a=delete&id=${users_info[0]}','${users_info[4]}');\" /></td>\n";
	$users_list .= "</tr>\n";
}
$print_html = <<"EOF";
