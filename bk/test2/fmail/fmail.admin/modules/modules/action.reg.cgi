...
for($cnt=0;$cnt<@registry;$cnt++){
	...
	$registry_list .= "<td style=\"width: 40px;\"><img src=\"images/button_edit.gif\" width=\"30\" height=\"20\" alt=\"編集\" class=\"button\" onclick=\"location.href='?m=$form{'m'}&a=form&id=$registry_info[0]&module=$form{'id'}'\" /></td>\n";
	$registry_list .= "<td style=\"width: 40px;\"><img src=\"images/button_delete.gif\" width=\"30\" height=\"20\" alt=\"削除\" class=\"button\" onclick=\"delete_confirm('?m=$form{'m'}&a=delete&id=${registry_info[0]}&module=$form{'id'}','${registry_info[0]}');\" /></td>\n";
	$registry_list .= "</tr>\n";
}
$print_html = <<"EOF";
