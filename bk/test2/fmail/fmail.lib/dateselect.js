<!--
	...
	//year
	document.write('<select id="'+dateselect_yearElementsId+'" name="'+dateselect_yearElementsId+'" onchange="dateselect_change(this.form.id,'+"'"+dateselect_yearElementsId+"',"+"'"+dateselect_monthElementsId+"',"+"'"+dateselect_dayElementsId+"'"+')" style="font-size: 100%\;">');
	...
	//month
	document.write('<select id="'+dateselect_monthElementsId+'" name="'+dateselect_monthElementsId+'" onchange="dateselect_change(this.form.id,'+"'"+dateselect_yearElementsId+"',"+"'"+dateselect_monthElementsId+"',"+"'"+dateselect_dayElementsId+"'"+')" style="font-size: 100%\;">');
	document.write('<option value=""></option>');
	...
	document.write('<select id="'+dateselect_dayElementsId+'" name="'+dateselect_dayElementsId+'" onchange="dateselect_change(this.form.id,'+"'"+dateselect_yearElementsId+"',"+"'"+dateselect_monthElementsId+"',"+"'"+dateselect_dayElementsId+"'"+')" style="font-size: 100%\;">');
	document.write('<option value=""></option>');
