...
<title><!--%%fmail-printable-area-title%%-->｜バリア・ブンタウ省進出完全ガイド</title>
...
<div id="wrapper">
  <div id="header">
    <h1><!--%%fmail-printable-area-title%%--> ｜バリア・ブンタウ省進出完全ガイド</h1>
    <div id="logo">
      ...
      <ul>
        ...
        <li><a href="fmail.cgi"><img src="../images/b_mail_off.jpg" alt="メールでお問い合わせはこちらから" width="238" height="50" border="0" /></a></li>
      </ul>
    </div>
    <div id="globalNav" class="clearfix">
      <ul class="global-navi">
        <li><a href="../"><img src="../images/b_navi01_off.jpg" width="144" height="47" alt="トップページ" /></a></li>
        <li><a href="../news.php"><img src="../images/b_navi02_off.jpg" width="119" height="47" alt="更新情報 " /></a> <ul>
            <li><a href="../gallery.php">写真・動画集</a></li>
          </ul></li>
  ...
  <div id="wrap_content">
    <div id="main" class="cf">
      ...
      <div id="content">
        <div class="section"> 
          <p><a href="../rule.html"><img src="../images/b_rule_off.jpg" width="725" height="83" alt="利用規約／個人情報の取扱いについて" /></a></p>
                    
          <!--%%fmail-invisible-contents-start%%--> 
          <!--%%fmail-invisible-contents-end%%-->
          
          <h3><!--%%fmail-printable-area-title-body%%--></h3>
...
<ul>
        ...
        <div class="box_snavi_exchange">
          ...
          </dl>          <div class="right">参照元<img src="../images/logo-EXIM-2.gif" alt="" title="" /></div>
</div>
        <!-- / #nav --></div>
...
<address id="copyright" class="clearfix">Copyright©2013 バリア・ブンタウ省進出支援 日本事務所 All Rights Reserved.</address>
    <!-- / #footer --></div>
