...
function list()		
{
		...
		{	 
				$(data).find("New").each(function()
				{
				 ...
				 var elem =('<dl><dt><img src="admin/image/'+image+'" width="93" height="59" alt=" "/></dt><dd class="text_t">'+title+'</dd><dd class="text_t">'+dateposted+'</dd><dd class="detail"><a href="detailnew-'+no+'.html"><img src="images/b_detail_off.jpg" width="113" height="17" alt="もっと見る" /></a></dd></dl>');
  ...
  <div id="header">
    ...
    <div id="logo">
      ...
      <ul>
        ...
        <li><a href="#"><img src="images/b_mail_off.jpg" alt="メールでお問い合わせはこちらから" width="238" height="50" border="0" /></a></li>
      </ul>
    </div>
    <div id="globalNav" class="clearfix">
      <ul class="global-navi">        <li><a href="./"><img src="images/b_navi01_off.jpg" width="144" height="47" alt="トップページ" /></a></li>
      ...
      <div id="nav">
        ...
        <div class="box_snavi_black">
          ...
          <ul>
            ...
            <li><a href="investment/infrastructure.html"><img src="images/b_snavi07_off.jpg" width="234" height="55" alt="インフラ" /></a></li>
          </ul>
        </div>
        <div class="box_snavi_blue">
          ...
          <ul>
            ...
            <li><a href="gallery.php"><img src="images/b_snavi10_off.jpg" width="234" height="41" alt="写真・動画集" /></a></li>
            ...
            <li><a href="#"><img src="images/b_snavi13_off.jpg" width="234" height="41" alt="お問い合わせフォーム" /></a></li>
...
<script src="http://vnexpress.net/Service/Forex_Content.js" type="text/javascript" language="javascript"></script> 
          ...
          <div class="right">ソース <img src="images/logo-EXIM-2.gif" alt="" title="" /></div>
        </div>
        <!-- / #nav --></div>
  ...
  <div id="footer">
    ...
    <div id="footer_link">
      ...
      <ul>        <li class="title_under">工業団地情報</li>
