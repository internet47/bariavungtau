...
<body id="underpage" class="detail_news">
<div id="wrapper">
  <div id="header">
    ...
    <div id="logo">
      ...
      <ul>
        ...
        <li><a href="fmail/fmail.cgi"><img src="images/b_mail_off.jpg" alt="メールでお問い合わせはこちらから" width="238" height="50" border="0" /></a></li>
      </ul>
    </div>
    <div id="globalNav" class="clearfix">
      <ul class="global-navi">
        <li><a href="./"><img src="images/b_navi01_off.jpg" width="144" height="47" alt="トップページ" /></a></li>
        <li><a href="news.php"><img src="images/b_navi02_off.jpg" width="119" height="47" alt="更新情報 " /></a>
         <ul>
  ...
  <div id="wrap_content">
    <div id="main" class="cf">
      ...
      <div class="pathway"><a href="./">バリア・ブンタウ省進出完全ガイド</a> &nbsp;&gt;&gt;&nbsp;<a href="news.php">更新情報</a>&nbsp;&gt;&gt;&nbsp; <span id="tit"></span></div>
      <div id="content">
        <div class="section">
          <?
		global  $title;
			...
			foreach($xml->children() as $Positions)
			{
				foreach($Positions->children() as $Position => $data)
				{
					...
					if ($no_inxml==$no) 
					{
					  ...
					  $dateposted = $data->dateposted;
					  $dateposted = str_replace("/","-",$dateposted);
					  $time = strtotime($dateposted);

					  $newformat = date('Y-m-d H:i:s',$time);
					  
					  
					  echo '<h3 class="title_new">'.$title.'</h3>';
					   echo '<p class="date_new_detail">'.$newformat.'</p>';
