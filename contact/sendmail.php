...
if ($sub)
{
	...
	#################################################
/*		$host ="jp.baria-vungtau.gov.vn" ;
		$port = 25 ;
		$name_of_to = "Webmaster";
		$email_of_to = "viettq@freesale-vietnam.com" ;
		$user = "no-reply@jp.baria-vungtau.gov.vn";
		$pass = "Sct@Brvt-admin";*/
		
		
		//$host ="mail.freesale-vietnam.com" ;
		//$port = 25 ;
		$name_of_to = "Webmaster - Form Mail";
		$email_of_to = "hiepvd@soct.baria-vungtau.gov.vn" ;
		//$user = "";
		//$pass = "";
	...
	if (empty($email) || empty($name) || empty($type) || empty($company) || empty($body) || empty($position))
		...
		/////////////////////////////////SWIFT MAILER ///////////////////////////////////////////
			...
			//$transport->setEncryption('starttls');
			...
			/////////////////////////////PHP MAILER//////////////////////////////////////	
				...
				smtpmailer($email_of_to, 'no-reply@jp.baria-vungtau.gov.vn', $name_of_to, $topic, $body);
...
function smtpmailer($to, $from, $from_name, $subject, $body) 
			{ 
				...
				if(!$mail->Send()) {
					...
					echo $error = 'Message sent to hiepvd@soct.baria-vungtau.gov.vn.';
					return true;
				}
			}
