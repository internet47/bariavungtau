  ...
  <div id="header">
    ...
    <div id="logo">
      ...
      <ul>
        ...
        <li><a href="../contact/index.php"><img src="../images/b_mail_off.jpg" alt="お問い合わせはこちらから" width="238" height="50" border="0" /></a></li>
</ul>
    </div>
  ...
  <div id="wrap_content">
    <div id="main" class="cf">
      ...
      <div id="content">
        ...
        <h3><img src="../images/title_thanks.gif" width="725" height="110" alt="お問い合わせフォーム" /></h3>
        <div class="box01">
        <p>お問い合わせいただき、誠にありがとうございました。<br />
折り返しご連絡いたしますので今しばらくお待ちください。</p>

<p class="bold">自動返信メールが届いていない場合は、メールアドレスが誤っている可能性がありますので、<br />
その際はお電話またはメールフォームより再度お問い合わせください。
</p>
<p>この度はお問い合わせいただき、ありがとうございました。<br />
重ねて御礼申し上げます。
</p>        
        <form method="post" enctype="multipart/form-data" action="../confirmmail.php" name="form_mail" id="form">
          <p class="center">
            <input type="submit" name="submit" value="トップページへ" id="send" /></p>
</form>
  ...
  <div id="footer">
    ...
    <div id="footer_link">
      <ul>
        ...
        <li><a href="../partner.html">パートナーリンク</a></li>
        <li><a href="../rule.html">利用規約／個人情報の取扱いについて</a></li>        <li><a href="index.php">お問い合わせ</a></li>
