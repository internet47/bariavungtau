...
<div id="wrapper">
  <div id="header">
    ...
    <div id="logo">
      ...
      <ul>
        <li><img src="images/tel.jpg" width="238" height="50" alt="(84)-64-385-0019 月～金:07：30～16：30" /></li>
        <li><a href="../../cgi-bin/fmail.cgi"><img src="images/b_mail_off.jpg" alt="お問い合わせはこちらから" width="238" height="50" border="0" /></a></li>
      </ul>
    </div>
  ...
  <div id="wrap_content">
    <div id="main" class="cf">
      ...
      <div class="pathway"><a href="http://jp.baria-vungtau.gov.vn/">バリア・ブンタウ省進出完全ガイド</a> &nbsp;&gt;&gt;&nbsp;<a href="news.html">更新情報</a>&nbsp;&gt;&gt;&nbsp; <span id="tit"></span></div>
      <div id="content">
        <div class="section">
          <?
		global  $title;
			...
			foreach($xml->children() as $Positions)
			{
				foreach($Positions->children() as $Position => $data)
				{
					...
					if ($no_inxml==$no) 
					{
					  ...
					  echo '<img src="admin/image/thumb1/'.$image.'" width="380" height="252" alt="'.$title.'" />';
					  echo '<p>'.$long.'</p>';
      ...
      <div id="nav">
       ...
       <div class="box_snavi_black">
         ...
         </div>            <div class="box_snavi_exchange">
          <p><img src="images/title_snavi-08.jpg" width="234" height="40" alt="為替レート" /></p>
          <ul>
...
<li><a href="industry/index.html"><img src="images/b_snavi09_off.jpg" width="234" height="41" alt="工業団地マップ" /></a></li>
            ...
            <li><a href="../../cgi-bin/fmail.cgi"><img src="images/b_snavi13_off.jpg" width="234" height="41" alt="お問い合わせフォーム" /></a></li>
