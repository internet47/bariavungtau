...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Ba Ria Vung Tau of Management System</title>
	...
	<div id="header">
        ...
        <hgroup>
            ...
            <?php 
			 ...
			 ?>
            <p><?php echo '<b>Login time:</b> '.$_SESSION['logindate']; ?></p>
...
document.getElementById('clockbox').innerHTML="<b>Curent time:</b> "+(nmonth+1)+"/"+ndate+"/"+nyear+" "+nhour+":"+nmin+":"+nsec+ap+"";
setTimeout("GetClock()", 1000);
}
window.onload=GetClock;
</script> 
<p>
<span id="clockbox"></span></p>
...
<nav>
	<ul class="menu">
		<li class="item1 active" id="one"><a href="#one"><img src="images/menu.png"> Google Map </a>
			<ul>
                <li class="subitem2"><a href="managelist.php" target="mainFrame">Category List </a></li>
				<li class="subitem2"><a href="getmap.php" target="mainFrame">Location List </a></li>
				<li class="subitem1"><a href="getLocation.php" target="mainFrame">Add Location </a></li>
			</ul>
		</li>
		<li class="item2 active" id="two"><a href="#two"><img src="images/menu.png"> Gallery</a>
			<ul>
       ...
       <li class="item2 active" id="three"><a href="#two"><img src="images/menu.png"> News</a>
			<ul>
				<li class="subitem1"><a href="listnews.php" target="mainFrame">News List</a></li>
			</ul>
		</li>
        <li class="item2 active" id="three"><a href="#two"><img src="images/menu.png"> Systems</a>
			<ul>
				<li class="subitem1"><a href="changepass.php" target="mainFrame">Change Password</a></li>
                <li class="subitem1"><a href="forgetpass.php" target="mainFrame">Forget Password</a></li>
                <li class="subitem1"><a href="syslog.php" target="mainFrame">Logs</a></li>
			</ul>
		</li>
