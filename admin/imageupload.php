...
<aside>
    ...
    <?php
		...
		if(isset($_POST['submit']))
		{
			...
			$status = 1;	
			if($val=='' || $valthumb=='')
				echo 'Add gallery image not complete';
			else
			{
				...
				echo'</script>';
				$_SESSION['content'] .= 'Posted the image '.$val.'<br />';
...
function validation(thisform)
    ...
    <form action="#" method="POST" id="contact" name="form" enctype="multipart/form-data" onSubmit="return validation(this)">
        ...
        <div class="frmname"><input type="text" class="required" id="datapicker" name="dateimage" value="" readonly /></div>
