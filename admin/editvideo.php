...
<aside>
	<div class="navbar">
    	<ul>
            ...
            <li><a href="#"><span>Edit Video</span></a></li>
        </ul>
    </div>
</aside>
...
<?php //include('config.php');
	...
	?>
		...
		<div class="sixteen columns">
			<h1 class="remove-bottom">Form Edit Video </h1>
	...
	<div id="contentfrm">
     ...
     <?php include('config.php');
		...
		if(isset($_GET['editid']))
		{
			...
			$stredit ='';
			$data = get_data('videos','*','id,=,'.$_GET['editid'].'');
        ...
        <div class="frmname"><input type="text" class="required" name="videotitle" value ="'.$value['title'].'" maxlength="30"></div>
        
        <div class="texttitle">Video Description</div>
        <div class="frmname"><textarea name="videodesctiption" class="required" cols="20" rows="5" onKeyDown="limitText(this.form.videodesctiption,this.form.countdown,200);" onKeyUp="limitText(this.form.videodesctiption,this.form.countdown,200);">'.$value['description'].'</textarea>
        ...
        <div class="frmname"><input type="text" class="required" id="datapicker" readonly="readonly" name="datevideo" value ="'.$value['date'].'" /></div>
		...
		if(isset($_POST['submit']))
		{
			...
			{
				//echo 'Add gallary image not complete';
				//update_data('images',array('id',$_GET['editid']),array($_GET['editid'],$imagetitle,$imagedescription,$img,$dateimage,$status));
				
				update_data('videos',array('id',$_GET['editid']),array($id,$videotitle,$videodesctiption,$al,$ad,$date,$status));
				header('Location: listvideo.php');	
			}
			else
			{
				update_data('videos',array('id',$_GET['editid']),array($id,$videotitle,$videodesctiption,$link,$val,$date,$status));
				$_SESSION['content'] .= 'Modified the video '.$val;
				header('Location: listvideo.php');	
			}
		}
