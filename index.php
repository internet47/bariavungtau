<html><body id="indexPage"><script type="text/javascript">
<!--
//
...
<title>バリア・ブンタウ省進出完全ガイド ～バリア・ブンタウ省公式日本語版サイト～</title>
<meta name="Keywords" content="ベトナム,進出,海外進出,日本企業,工場,バリア・ブンタウ,工業団地,誘致企業" />
<meta name="Description" content="ベトナム南部最大の工業区、バリア・ブンタウ省公式日本語版サイト。「バリアブンタウ省進出支援 日本事務所」が運営し、進出希望の日本企業を全面的にサポートします。" />
...
function list()		
{
		...
		{
				$(data).find("New").slice(1, 5).each(function()
				{		
				    ...
				    var elem = ('<dl><dt><img src="admin/image/thumb2/'+image+'" width="93" height="59" alt="'+title+'" /></dt><dd class="text_t"><a href="detailnew-'+no+'.html">'+title+'</a><dd class="dateposted">'+dateposted+'</dt><dd class="detail"><a href="detailnew-'+no+'.html"><img src="images/b_detail_off.jpg" width="113" height="17" alt="詳細情報を見る" class="details" /></a></dd></dl>');
...
<div id="wrapper">
  <div id="header">
    <h1>バリア・ブンタウ省進出完全ガイド ～バリア・ブンタウ省公式日本語版サイト～</h1>
    <div id="logo">
      <p><a href="http://jp.baria-vungtau.gov.vn/"><img src="images/logo.jpg" width="635" height="106" alt="バリア・ブンタウ省進出完全ガイド" /></a></p>
      <ul>
        <li><img src="images/tel.jpg" width="238" height="50" alt="(84)-064-000-000 月～金:08：00AM～17：00PM" /></li>
    ...
    <div id="main" class="cf">
      ...
      <div id="content">
        ...
        <div id="News">
          <div class="n_boxLeft">
            <dl>
             <? 
			    $arr= array();
				$xml = simplexml_load_file("admin/data/news.xml") or die("Can not read data XML file. Please check permission on folder Data. thks: Cannot create object");
			...
			foreach($xml->children() as $Positions)
			{
				foreach($Positions->children() as $Position => $data)
				{
					...
					if ($no_inxml==$top) 
					{
					 ...
					 echo  '<dt><span class="title_news"><a href="detailnew-'.$no_inxml.'.html">'.$title.'</a></span></dt>';
					 echo '<dd><img src="admin/image/'.$image.'" width="380" height="252" alt="'.$title.'" /><dd><br />';
            		 echo  $short;
					 echo '</dt>';
					}
				}
        ...
        <div class="cont">
          ...
          <p class="fright"><a href="living_information.php"><img src="images/banner_index02_off.jpg" width="352" height="99" alt="生活情報マップ" /></a></p>
        </div>
        ...
        <div class="box_video mb20">
          <div id="flashContent">
            <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="720" height="540">
              <param name="movie" value="intro_BariaVungtau.swf">
              ...
              <!--[if !IE]>-->
              <object type="application/x-shockwave-flash" data="intro_BariaVungtau.swf" width="720" height="540">
                <!--<![endif]-->
                <param name="quality" value="high">
                <param name="wmode" value="opaque">
                <param name="swfversion" value="11.0.0.0">
      ...
      <div id="nav">
        ...
        <div class="box_snavi_exchange"><p class="mb05"><img src="images/title_snavi-08.jpg" width="234" height="40" alt="menu" /></p>
