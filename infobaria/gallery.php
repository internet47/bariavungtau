...
<div id="wrapper">
  <div id="header">
    ...
    <div id="logo">      <p><a href="http://jp.baria-vungtau.gov.vn/"><img src="../images/logo.jpg" width="635" height="106" alt="バリア・ブンタウ省進出完全ガイド" /></a></p>
<ul>
        <li><img src="../images/tel.jpg" width="238" height="50" alt="(84)-064-000-000 毎日:08：00AM～17：00PM" /></li>
        <li><a href=""><img src="../images/b_mail_off.jpg" width="238" height="50" alt="お問い合わせはこちらから" /></a></li>
      </ul>
    </div>
    <div id="globalNav" class="clearfix">
      <ul>
        <li><a href="#"><img src="../images/b_navi01_off.jpg" width="144" height="47" alt="トップページ" /></a></li>
        <li><a href="gallery.html"><img src="../images/b_navi02_off.jpg" width="119" height="47" alt="更新情報 " /></a></li>
      ...
      <div id="nav">
        ...
        <div class="box_snavi_blue">
          ...
          <ul>
            ...
            <li><a href="#"><img src="../images/b_snavi12_off.jpg" width="234" height="41" alt="パートナーリンク" /></a></li>                        <li><a href="../contact/index.php"><img src="../images/b_snavi13_off.jpg" width="234" height="41" alt="お問い合わせフォーム" /></a></li>
...
<li><a href="#"><img src="../images/b_snavi14_off.jpg" width="234" height="41" alt="サイトマップ" /></a></li>
  ...
  <div id="footer">
    ...
    <div id="footer_link">
      <ul>        <li class="title_home"><a href="http://jp.baria-vungtau.gov.vn/">TOPページ</a> </li>
<li><a href="#">更新情報</a></li>
        <li><a href="#">生活情報</a></li>
        <li><a href="#">よくある質問</a></li>        <li><a href="../contact/index.php">お問い合わせ</a></li>
