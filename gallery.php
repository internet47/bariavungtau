...
<title>写真・動画集 ｜バリア・ブンタウ省進出完全ガイド ～バリア・ブンタウ省公式日本語版サイト～</title>
<meta name="Keywords" content="ベトナム,進出,海外進出,日本企業,工場,バリア・ブンタウ,工業団地,誘致企業" />
<meta name="Description" content="写真・動画集 | ベトナム南部最大の工業区、バリア・ブンタウ省公式日本語版サイト。「バリアブンタウ省進出支援 日本事務所」が運営し、進出希望の日本企業を全面的にサポートします。" />
...
<div id="wrapper">
<div id="header">
  <h1>写真・動画集 ｜バリア・ブンタウ省進出完全ガイド ～バリア・ブンタウ省公式日本語版サイト～</h1>
  <div id="logo">
    ...
    <ul>
      ...
      <li><a href="contact/index.php"><img src="images/b_mail_off.jpg" width="238" height="50" alt="お問い合わせはこちらから" /></a></li>
    </ul>
  </div>
  <div id="globalNav" class="clearfix">
    <ul class="global-navi">
      <li><a href="http://jp.baria-vungtau.gov.vn/"><img src="images/b_navi01_off.jpg" width="144" height="47" alt="トップページ" /></a></li>
      <li><a href="news.html"><img src="images/b_navi02_on.jpg" width="119" height="47" alt="更新情報 " /></a>
        <ul>
...
<div class="main_img">
  <h2><img src="images/h2_gallery.jpg" width="975" height="193" alt="写真・動画集" /></h2>
</div>
<div class="pathway"><a href="http://jp.baria-vungtau.gov.vn/">バリア・ブンタウ省進出完全ガイド</a> &nbsp;&gt;&gt;&nbsp;写真・動画集</div>
<div id="content">
  <h3><img src="images/h3_gallery01.jpg" width="725" height="49" alt="写真集" /></h3>
  <div id="example">
    <div class="imageRow">
      <div class="set">
        <?php 
				...
				else
				{
					...
					{
						$str =$str.'
						<div class="single"><a href="admin/uploads/images/thumbs/'.$data[$i]['thumbs'].'" rel="prettyPhoto[gallery]" title="'.$data[$i]['title'].'"  des="'.$data[$i]['description'].'">
						<img src="admin/uploads/images/thumbs/'.$data[$i]['thumbs'].'" alt="'.$data[$i]['title'].'" width="150" height="150" />
						<p>'.$data[$i]['title'].'</p> </a> </div>
						';
					}
			...
			echo '<div class="page"><div class="leftrightpaging">';
			//echo '<span>page: </span>';
			...
			else
			{
				...
				if($pagenext>0)
				{
					...
					echo '<span class="next"><a class="next" href="'.$linknext.'">前</a></span>';	
				}
			}
			for($i=1;$i<=$st;$i++)
			{
			...
			else
			{
				...
				else
				{
					$pagenext = $page+1;
					$linknext = '?page='.$pagenext.'';
					echo '<span class="next"><a class="next" href="'.$linknext.'">次</a></span>';
				}
			}
		echo '</div></div>';
      ...
      <h3><img src="images/h3_gallery02.jpg" width="725" height="49" alt="動画集" /></h3>
      <div class="imageRow">
        <div class="set">
          <?php 
			  	//include('config.php');
				...
				/* paging video */
				$lineperpage1 = 2;
				$num1 = count($datavideo);
					/* pagin */
				$st1=ceil($num1/$lineperpage1);
				if(isset($_GET['page1']))
				{ 
					$page1 = $_GET['page1'];
				}
				...
				{
					$start1 = ($page1 - 1) * $lineperpage1;
				}
				$end1 = $start1 + $lineperpage1;
				if ($end1 > $num1)
				{
					$end1 = $num1;
				}
				// xuat thong tin video */
				if($count==NULL)
				{
					$str='動画はまだありません。';
				}
				else
				{
					...
					{
						if($datavideo[$i1]['link']=='' && $datavideo[$i1]['video']=='')
						{
							// khong co video
							$str =$str.'';
						}
						else
						{
							if($datavideo[$i1]['link']!='' && $datavideo[$i1]['video']!='')
							{
								...
								$str =$str.'
								<div class="single">
								<a href="'.$datavideo[$i1]['link'].'" rel="prettyPhoto" title="'.$datavideo[$i1]['title'].'" des="'.$datavideo[$i1]['description'].'">
								<img src="images/gallery/thumb-7.jpg" alt="'.$datavideo[$i1]['title'].'" /><p>'.$datavideo[$i1]['title'].'</p></a>
								</div>
								';
							}
							else
							{
								if($datavideo[$i1]['link']=='')
								{
									// xuat video tu may tinh
									$str =$str.'<div class="single">
									<div class="videogallery">
										<a class="voverlay" href="index_videolb/player.swf?url=../admin/uploads/videos/'.$datavideo[$i1]['video'].'&volume=100" title="'.$datavideo[$i1]['description'].'">
										<img src="images/gallery/thumb-7.jpg" alt="test" width="150" height="150" /><p>'.$datavideo[$i1]['title'].'</p></a>
									</div></div>
										';
								}
								else
								{
									...
									$str =$str.'
									<div class="single">
								<a href="'.$datavideo[$i1]['link'].'" rel="prettyPhoto" title="asdasdasdas" des="'.$datavideo[$i1]['description'].'">
								<img src="images/gallery/thumb-7.jpg" alt="'.$datavideo[$i1]['title'].'" /><p>'.$datavideo[$i1]['title'].'</p></a>
								</div>
										';
								}
			...
			else
			{
				...
				if($pagenext1>0)
				{
					$linknext1 = '?page1='.$pagenext1.'';
					echo '<div class="next"><a class="next" href="'.$linknext1.'">前</a></div>';	
				}
			}
			for($i1=1;$i1<=$st1;$i1++)
			{
			...
			else
			{
				...
				else
				{
					$pagenext1 = $page1+1;
					$linknext1 = '?page1='.$pagenext1.'';
					echo '<div class="next"><a class="next" href="'.$linknext1.'">次</a></div>';
				}
			}
		echo '</div></div>';
      ...
      <div id="nav">
        ...
        <div class="box_snavi_exchange">
          <p><img src="images/title_snavi-08.jpg" width="234" height="40" alt="menu" /></p>
          <ul>
            ...
            <li><a href="contact/index.php"><img src="images/b_snavi13_off.jpg" width="234" height="41" alt="お問い合わせフォーム" /></a></li>
